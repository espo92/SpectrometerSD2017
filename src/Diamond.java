...
public class Diamond extends JFrame {
	...
	public Diamond() {
		...
		JLabel lblWeRecommend = new JLabel("contain Diamond. These results are due to the sample having");
		...
		JLabel lblNotEncounterUnexpected = new JLabel("peaks at 1332 cm^(-1)");
		...
		lblNotEncounterUnexpected.setBounds(136, 222, 432, 19);
