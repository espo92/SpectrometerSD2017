...
public class Asha extends JFrame {
	...
	public Asha() {
		...
		JLabel lblWeRecommend = new JLabel("contain Asha. These results are due to the sample having");
		...
		JLabel lblNotEncounterUnexpected = new JLabel("peaks at 1332, 1438 and 1533 cm^(-1)");
