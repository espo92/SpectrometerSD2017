...
public class PurpleGem extends JFrame {
	...
	public PurpleGem() {
		...
		JLabel lblWeRecommend = new JLabel("be the Purple Gem. These results are due to the sample having");
		...
		JLabel lblNotEncounterUnexpected = new JLabel("peaks at 1381 cm^(-1)");
		...
		lblNotEncounterUnexpected.setBounds(137, 222, 432, 19);
